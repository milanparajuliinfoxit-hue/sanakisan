      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="rounded-xl border bg-card">
          <div className="px-5 py-4 border-b border-border">
            ...
            <p className="text-sm text-muted-foreground mt-0.5">Enter the main details of your press release</p>
          </div>
        ...
        <div className="rounded-xl border bg-card">
          <div className="px-5 py-4 border-b border-border">
            ...
            <p className="text-sm text-muted-foreground mt-0.5">Upload a cover image for the press release</p>
          </div>
          <div className="p-5">
            <Controller
              name="featuredImage"
        ...
        <div className="rounded-xl border bg-card">
          <div className="px-5 py-4 border-b border-border">
            <h3 className="font-semibold text-foreground">Content <span className="text-destructive">*</span></h3>
            <p className="text-sm text-muted-foreground mt-0.5">Write the main content of the press release</p>
          </div>
          <div className="p-5">
            <Controller
              name="content"
              ...
              render={({ field, fieldState: { error } }) => (
                <div>
                  ...
                  {error && <span className="text-xs text-destructive mt-1 block">{error.message}</span>}
                </div>
              )}
            />
          </div>
        ...
        <div className="flex items-center gap-3 justify-end">
          ...
          <Button type="submit">
            {mode == 'update' ? "Update Press Release" : "Save Press Release"}
          </Button>
        </div>
      </form>
    </div>
