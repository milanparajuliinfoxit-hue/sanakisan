...
const CreateEvent = ({ selectedEvent, mode, setMode, onSuccess }) => {
  const { control, handleSubmit, setValue, reset } = useForm({
    defaultValues: { title: "", featuredImage: "", content: "", publishStatus: "", author: "", event_date: "" },
  });
  ...
  const onSubmit = async (data, publishStatus) => {
    ...
    if (mode === "update") formData.append("id", selectedEvent?.id);
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-xl border border-border bg-card shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-border bg-muted/30">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">Enter the main details of the event</p>
          </div>
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="space-y-1.5">
              ...
              <Controller name="event_date" control={control} rules={{ required: "Event Date is required" }}
                render={({ field, fieldState: { error } }) => (
                  <>
        ...
        <div className="rounded-xl border border-border bg-card shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-border bg-muted/30">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">Write the main body of the event</p>
          </div>
          <div className="p-6">
