...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col px-2 min-h-screen sticky overflow-y-auto bg-green-100">
      <div className="flex flex-row justify-center items-center py-2 gap-2">
        <img src="/jalthal.png" className="size-12" alt="Jalthal Logo" />
        <div className="font-display text-primary-800 font-bold text-sm leading-tight">
          साना किसान कृषि सहकारी संस्था लि.
        </div>
      </div>
      <hr className="bg-black h-[2px] rounded-full" />
