            ...
            <Route
              ...
              element={
                <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 py-16 text-center">
                  <div className="mb-5 flex h-16 w-16 items-center justify-center rounded-full border border-emerald-200 bg-emerald-50 text-4xl">
                    🌿
                  </div>
                  <h1 className="mb-2 font-display text-3xl font-semibold text-emerald-950">
                    Page Not Found
                  </h1>
                  <p className="mb-6 max-w-md text-base leading-8 text-slate-600">
                    The page you are looking for may have moved or no longer
                    exists.
                  </p>
                  <a
                    href="/"
                    className="inline-flex items-center gap-2 rounded-full bg-emerald-800 px-6 py-2.5 font-semibold text-white transition hover:bg-emerald-700"
                  >
                    Go Home
                  </a>
                </div>
